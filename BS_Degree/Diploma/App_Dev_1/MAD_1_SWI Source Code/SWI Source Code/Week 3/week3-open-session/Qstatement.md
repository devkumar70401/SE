...
- Copy the Product data in the python file *app.py* from the *Products.txt* file provided
...
- Save this HTML file as *output.html* as an external file in the in the working directory.
...
Note: Same steps can be followed to segregate the table with respect to *type*
